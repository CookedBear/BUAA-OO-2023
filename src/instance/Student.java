...
public class Student {
    ...
    public boolean hasBook() { return !bookState.isEmpty(); }

    public boolean allSmash() {
        int state = 0;
        for (Book book : bookState.keySet()) {
            state += bookState.get(book);
        }
        return state == bookState.size();
    }

    public HashMap<Book, Integer> getBag() { return bookState; }
}
