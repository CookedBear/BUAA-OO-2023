...
//+(+z**0--z**1*z**+2*x++3*-2*z-+x**+0--x*0*0-+z**1*0*+2--2+y*0*-4---2)**+0+z*(--y**1*0)+(+x*0*z+0++z*x++0*+1*-4++0*y**+1*1-+0*y*922337203685+0*0+x*922337203685*0--y*0+y)*y**0*+2-922337203685+z-+z*y*(+-z**0+x**1+-0)**2--4
